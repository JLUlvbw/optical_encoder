...
% 在图上添加谐波占比文本
%fundamental order
text(freq_d(main_freq_idx)-0.025, main_amplitude_int+1.9, 'Fundamental order', 'FontSize', 10, 'Color', 'r');


%text(freq_d(main_freq_idx)+0.01, main_amplitude_int, '基频', 'FontSize', 10, 'Color', 'r');
%harmonic order 3rd

text(freq_d(third_int_idx)-0.055, third_amplitude_int+3.4, ...
...
grid on;
box on;
legend('Single-field spectrum', 'Fundamental order', 'Harmonic order 3rd', 'Harmonic order 5th', 'Location', 'northeast');
