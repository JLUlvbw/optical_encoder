...
% 在图上添加谐波占比文本
%fundamental order
text(freq_d(main_freq_idx)-0.025, main_amplitude_int+7.5, 'Fundamental order', 'FontSize', 10, 'Color', 'r');


%text(freq_d(main_freq_idx)+0.01, main_amplitude_int, '基频', 'FontSize', 10, 'Color', 'r');
%harmonic order 3rd

text(freq_d(third_int_idx)-0.055, third_amplitude_int+7.5, ...
    sprintf('Harmonic order 3rd: %.2f%%', third_ratio_int), 'FontSize', 10, 'Color', 'b');
text(freq_d(fifth_int_idx)-0.055, fifth_amplitude_int+5, ...
