...
%harmonic order N
%spectrum
legend('Four-segmented spectrum', 'Fundamental order', 'Harmonic order 3rd', 'Harmonic order 5th','FontName','Palatino Linotype', 'FontSize', 14, 'Location', 'northeast');
...
% 在图上添加谐波占比文本
%fundamental order
text(freq_d(main_freq_idx)-0.025, main_amplitude_int+5, 'Fundamental order','FontName','Palatino Linotype', 'FontSize', 14, 'Color', 'r');
...
exportgraphics(gcf, 'figure11b.png', 'Resolution', 1200); 
% ==================== 对比分析图 ====================
figure;
subplot(3,1,1);
