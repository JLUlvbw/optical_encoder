...
grid on;
box on;
legend('Spectrum', 'Fundamental order', 'Harmonic order 3rd', 'Harmonic order 5th', 'FontName', 'Palatino Linotype', 'FontSize', 14 , 'Location', 'northeast');%legend('four-segmented spectrum', 'fundamental order', 'harmonic order 3rd', 'harmonic order 5th', 'Location', 'northeast');
%legend('频谱', '基频', '三次谐波', '五次谐波', 'Location', 'northeast');
exportgraphics(gcf, 'figure10d.png', 'Resolution', 1200); 
